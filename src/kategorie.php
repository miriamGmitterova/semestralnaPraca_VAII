...
<div class="relative flex w-full mt-16">
    <h1 class="mr-auto ml-auto text-xl font-bold text-pink-900 py-2">- ŽENY -</h1>
</div>
<!-- Pohlavie kategorie štart -->
<div class="grid sm:grid-cols-2 px-4 gap-y-4 gap-x-4 items-center w-full">
    <div class="w-full relative flex bg-pink-200 pilulka">
        <span class="ml-auto mr-auto py-6">Bundy</span>
        <a href="produkt.php" class="vyplnitDiv"></a>
    </div>
    <div class="w-full relative flex bg-pink-200 pilulka">
        <span class="ml-auto mr-auto py-6">Trička</span>
        <a href="produkt.php" class="vyplnitDiv"></a>
    </div>
    <div class="w-full relative flex bg-pink-200 pilulka">
        <span class="ml-auto mr-auto py-6">Nohavice</span>
        <a href="produkt.php" class="vyplnitDiv"></a>
    </div>
    <div class="w-full relative flex bg-pink-200 pilulka">
        <span class="ml-auto mr-auto py-6">Topánky</span>
        <a href="produkt.php" class="vyplnitDiv"></a>
    </div>
</div>
